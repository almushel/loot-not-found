...
substanceTypes[WATER] = { life: 100, quantity: 16, state: 2, effects: new Set([SMOKE, STEAM, SHOCK, GAS, WATER, BLOOD]), ondeath: NOEFF, };
...
const SOUND_EFFECTS = {
	'destroytile': [.75,.01,100,.02,,.6,4,1.33,-0.6,,,,.015,,40,.2,,.5],
	'lootpickup': [.3,,700,,.02,.16,,1.78,,,606,.05,,,.2,.04,,.51,,.11],
	'hammerhit' : [,,400,,,0,2,.8,,,,,,4,-0.5,.8,,.55,.05],
	'firebomb' : [.5,.02,356,.15,,.4,4,1.33,-0.6,,,,,,,.1,,.2,.3],
	'boom' : [,,1e3,,.02,.3,4,3,.8,.5,,,,,12,.7],
	'door' : [,,100,,.1,.2,1,2,,,100,.01,.05,.9,50,,,.4,.1,1],
	'pickup' : [.2,,1e3,,,.09,,.65,,49,,,,,120,,,.12,.02,.08],
	'drop' : [,,880,.1,,.25,,3,,,200,.2,,,59.9,,,.9],
	'select' : [.3,,1600,,,,,,,,-1600,.01,,,60],
	'use' : [,,440,.01,,,,,,,220,.012,,,60],
}
